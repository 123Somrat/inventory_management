...
export default function CreateShop() {
  const axiosbase = useAxiosSecure()
    ...
    const onSubmit = data =>{
       ...
       //create shop object
       const shopInfo = {shopname,shoplogo,shoplocation,description}
        axiosbase.post("/createshop",shopInfo)
  ...
  return (
    <div>
      <section className="p-6 dark:bg-gray-800 dark:text-gray-50 mx-auto">
        <form className="container flex flex-col mx-auto space-bottom-4" onSubmit={handleSubmit(onSubmit)}>
          <div className="w-full">
            <img src={shopsvg} className="w-16 h-16 mx-auto" />
            <p className="text-center text-xs text-cyan-700">Create your shop</p>
          </div>
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md  dark:bg-gray-900">
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-4">
              <div className="col-span-full sm:col-span-3">
                ...
                />
                {errors.Shopname && <span className="text-red-700 block mt-2 ml-2">Shop name is required</span>}
              </div>
              <div className="col-span-full sm:col-span-3">
                ...
                />
                {errors.shoplogo && <span className="text-red-700 block mt-2 ml-2">Shop logo is required</span>}
              </div>
              <div className="col-span-full sm:col-span-3">
                ...
                />
                {errors.shoplocation && <span className="text-red-700 block mt-2 ml-2">Shop location is required</span>}
              </div>
              <div className="col-span-full sm:col-span-3">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                ></textarea>
                {errors.bio && <span className="text-red-700 block mt-2 ml-2">Shop description is required</span>}
              </div>
            </div>
          </fieldset>
          
            <button
              className="px-8 py-3 font-semibold border rounded dark:border-gray-100 w-96 block mx-auto dark:text-gray-100 bg-cyan-700 text-white hover:bg-cyan-800"
            >
              Create Shop
            </button>
