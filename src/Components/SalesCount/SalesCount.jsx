  ...
  return (
	...
	<div className="container mx-auto grid justify-center  grid-cols-2 text-center lg:grid-cols-3">
		<div className="flex flex-col  justify-center m-2 lg:m-2 border-2 p-4 h-56 ">
			<p className="text-sm  lg:text-6xl">{details?.totalInvest ? details?.totalInvest : 0 }$</p>
			<p className="text-sm sm:text-base">Total Invest</p>
		</div>
		<div className="flex flex-col justify-center m-2 lg:m-2 border-2 p-4 h-56">
			<p className="text-sm leadi lg:text-6xl">{details?.totalSales ? (details?.totalSales).toFixed(1) : 0 }$</p>
			<p className="text-sm sm:text-base no-wrap">Total Sale</p>
		</div> 
		<div className="flex flex-col justify-center m-2 lg:m-2 border-2 p-4 h-56">
			<p className="text-sm leadi lg:text-6xl ">{details?.totalprofit ? (details?.totalprofit) .toFixed(1) : 0}$</p>
